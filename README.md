...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab_templates-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9647&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab_templates-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab_templates` can be installed with:

```
conda install jupyterlab_templates
```

It is possible to list all of the versions of `jupyterlab_templates` available on your platform with:

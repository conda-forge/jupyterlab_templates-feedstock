...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyterlab_templates-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyterlab_templates-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyterlab-templates jupyterlab_templates
# for installing globally
pixi global install jupyterlab-templates jupyterlab_templates
```
...
It is possible to list all of the versions of `jupyterlab-templates` available on your platform:
...
```
pixi search jupyterlab-templates --channel conda-forge
```
